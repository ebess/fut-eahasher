...
class EAHashor
{
    ...
    static public $R1Shifts = array( 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22 );
    static public $R2Shifts = array( 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20 );
    static public $R3Shifts = array( 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23 );
    static public $R4Shifts = array( 6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21 );
	...
	/**
	 * get the ea hash for given string
	 *
	 * @param string $string
	 * @return string|null
	 */
	...
	/**
	 * sets the string which will be hashed
	 *
	 * @param string $string
	 * @return $this
	 */
	...
	/**
	 * returns the ea hash or null if string is not set
	 *
	 * @return null|string
	 */
	public function getHashedString()
    {
        return ($this->string === null) ? null : $this->hash();
    }

	private function int32($val)
	{
    ...
    private function bitwiseRotate($x, $c)
    {
    	$x = $this->int32($x);
        return (int)(($x << $c) | ($this->uRShift($x,32-$c)));
    }

    private function uRShift($number, $shiftBits) 
    { 
	...
	private function chunkInput($input)
    {
    ...
    {
		$chunks = $this->chunkInput($this->string);
